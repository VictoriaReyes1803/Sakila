# Generated by Django 4.2.20 on 2025-04-04 04:15
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='FilmActor',
            fields=[
                ('actor', models.OneToOneField(on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, serialize=False, to='sakila_app.actor')),
                ('last_update', models.DateTimeField()),
            ],
            options={
                'db_table': 'film_actor',
        ...
        migrations.CreateModel(
            name='FilmCategory',
            fields=[
                ('film', models.OneToOneField(on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, serialize=False, to='sakila_app.film')),
                ('last_update', models.DateTimeField()),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('address', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='sakila_app.address')),
                ('role', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='sakila_app.roles')),
                ('store', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='staff_members', to='sakila_app.store')),
            ],
            options={
                'db_table': 'staff',
                'managed': True,
